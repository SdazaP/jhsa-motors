...
<div class="col-md-5">
    ...
    <form method="POST" action="../../controller/actions_marca.php">
        <div class="form-group input-group mb-3">
            ...
            <input type="hidden" class="form-control" name="txtID" value="<?php echo isset($_GET['txtID']) ? $_GET['txtID'] : ''; ?>">
            <input type="text" class="form-control" value="<?php echo isset($_GET['txtID']) ? $_GET['txtID'] : ''; ?>" placeholder="ID automático" disabled>
        </div>

        <div class="form-group input-group mb-3">
            <label class="input-group-text" for="inputGroupSelect01">Nombre</label>
            <input type="text" class="form-control" name="txtNombre" value="<?php echo isset($_GET['txtNombre']) ? $_GET['txtNombre'] : ''; ?>" placeholder="Nombre de la marca">
        </div>
